    ...
    <>
      <S.Container>
        <S.Content>
          <S.FirstSection>
            <S.ContainerImage>
              {data?.schoolPhoto?.link ? (
                <Image
                  layout="responsive"
                  loader={() => data.schoolPhoto.link}
                  src={data.schoolPhoto.link}
                  width={490}
                  height={500}
                  alt="escola"
                />
            ...
            <S.ContainerLeft>
              ...
              <S.ContainerLeftFooter>
                <section>
                  ...
                  {data?.logoPhoto?.link ? (
                    <Image
                      loader={() => data.logoPhoto.link}
                      src={data.logoPhoto.link}
                      width={100}
                      height={100}
                      alt="escola"
                      layout="responsive"
          ...
          <S.SecondSection>
            ...
            <S.SecondSectionChild2>
              <div>
                {data?.historial1?.link ? (
                  <Image
                    onClick={() => router.push(data.historial1?.link)}
                    loader={() => data.historial1.link}
                    src={data.historial1.link}
                    width={100}
                    height={90}
                    alt="escola"
                    layout="responsive"
              ...
              <div>
                {data?.historial2?.link ? (
                  <Image
                    onClick={() => router.push(data.historial2?.link)}
                    loader={() => data.historial2.link}
                    src={data.historial2.link}
                    width={100}
                    height={90}
                    alt="escola"
                    layout="responsive"
              ...
              <div>
                {data?.historial3?.link ? (
                  <Image
                    onClick={() => router.push(data.historial3?.link)}
                    loader={() => data.historial3.link}
                    src={data.historial3.link}
                    width={100}
                    height={90}
                    alt="escola"
                    layout="responsive"
              ...
              <div>
                {data?.historial4?.link ? (
                  <Image
                    onClick={() => router.push(data.historial4?.link)}
                    loader={() => data.historial4.link}
                    src={data.historial4.link}
                    width={100}
                    height={90}
                    alt="escola"
                    layout="responsive"
