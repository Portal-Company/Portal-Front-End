                ...
                <S.Content>
                    <S.FirstSection>
                        ...
                        <S.ContainerLeft>
                            ...
                            {subject.Curso.nome ? (<span>Curso: {subject.Curso.nome}</span>): null}
                            {subject.Curso.AreaDeFormacao.nome ? (<span>Área de Formação: {subject.Curso.AreaDeFormacao.nome}</span>) : null}
                            <p>
                                {subject?.descricao}
                            </p>
                        </S.ContainerLeft>
